...
import 'package:services_providers/utils/dialog_utils.dart';
...
Future<void> loginWithEmailAndPassword(
  ...
  try {
    ...
    if (userDoc.exists) {
      String userType = userDoc.get('typeUser') ?? 'مستخدم';
      bool isSuspended = userDoc.get('isSuspended');
      
      // التحقق من نوع المستخدم وحالته
      if (userType != 'مقدم خدمة') {
        await _auth.signOut();
        showMessageDialog(context, 'خطأ ❌', '⚠️ هذا الحساب ليس لمقدم خدمة');
